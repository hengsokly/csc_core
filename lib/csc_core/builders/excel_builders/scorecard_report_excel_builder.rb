      ...
      private
        ...
        def main_row(scorecard, count)
          [
            ...
            scorecard.participants.blank? ? nil : scorecard.participants.select { |p| p.gender == CscCore::Participant::MALE }.length,
        ...
        def rating(voting_indicator)
          CscCore::VotingIndicator.medians.map do |median|
