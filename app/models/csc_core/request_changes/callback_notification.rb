module CscCore::RequestChanges::CallbackNotification
  ...
  included do
    ...
    private
      ...
      def notify_scorecard_request_change_to_creators_async
        ::CscCore::RequestChangeWorker.perform_async(:notify_scorecard_request_change_to_creators, id)
      end

      def notify_status_rejected_to_proposer_async
        ::CscCore::RequestChangeWorker.perform_async(:notify_status_rejected_to_proposer, id)
      end

      def notify_status_approved_to_proposer_async
        ::CscCore::RequestChangeWorker.perform_async(:notify_status_approved_to_proposer, id)
      end
      ...
      def send_mail(email, display_message)
        ...
        ::CscCore::NotificationMailer.notify_request_change(email, option).deliver_now
      end
  end
end
