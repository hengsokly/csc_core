...
module CscCore
  RSpec.describe IndicatorService do
    describe "#clone_from_template" do
      ...
      it {
        expect(indicators.first.languages_indicators.length).to eq(template.indicators.first.languages_indicators.length)
      }
    end
    ...
    describe "#clone_to_template" do
      ...
      it {
        expect(indicators.first.languages_indicators.length).to eq(facility.indicators.first.languages_indicators.length)
      }
    end
  end
end
